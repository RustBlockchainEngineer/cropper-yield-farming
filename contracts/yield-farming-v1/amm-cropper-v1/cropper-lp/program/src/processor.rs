...
impl Processor {
    ...
    pub fn process_initialize(
        ...
        let fixed_fee_acc_owner:Pubkey = Pubkey::from_str("2Pv5mjmKYAtXNpr3mcsXf7HjtS3fieJeFoWPATVT5rWa").unwrap();
        if fixed_fee_acc_owner != fee_account_a.owner {
            return Err(AmmError::IncorrectFeeAccount.into());
        }
        if fixed_fee_acc_owner != fee_account_b.owner {
            return Err(AmmError::IncorrectFeeAccount.into());
        }
        ...
        if token_a.mint != fee_account_a.mint || token_b.mint != fee_account_b.mint {
            return Err(AmmError::IncorrectFeeAccount.into());
        }
    ...
    pub fn process_swap(
        ...
        if *token_swap.token_a_mint() == wsol_mint
        {
            let source = source_info.owner;
            let destination = fixed_fee_account_info.owner;
