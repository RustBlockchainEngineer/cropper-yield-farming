...
pub const REMOVE_REWARDS_FARM_ADDRESS:&str = if DEVNET_MODE {"6bt6PnzhhyAy23555DLiQEkjEu9nhjQf5KJFUu4ke4U7"} else {"H9jkwKVS6YFCY87EuxF4P2z1yCJ4a4px1bpL1i49AGkB"};