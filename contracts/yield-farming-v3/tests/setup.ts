...
export const CRP_MINT_ADDRESS = DEVNET_MODE ? 'GGaUYeET8HXK34H2D1ieh4YYQPhkWcfWBZ4rdp6iCZtG' : 'DubwWZNWiNGMMeeQHPnMATNj77YZPZSAz2WVR5WjLJqz';
export const USDC_MINT_ADDRESS = DEVNET_MODE ? '6MBRfPbzejwVpADXq3LCotZetje3N16m5Yn7LCs2ffU4' : 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v';
export const USDT_MINT_ADDRESS = DEVNET_MODE ? '6La9ryWrDPByZViuQCizmo6aW98cK8DSL7angqmTFf9i' : 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB';
export const SOL_MINT_ADDRESS = DEVNET_MODE ? 'So11111111111111111111111111111111111111112' : 'So11111111111111111111111111111111111111112';
export const ETH_MINT_ADDRESS = DEVNET_MODE ? '2FPyTwcZLUg1MDrwsyoP4D6s1tM7hAkHYRjkNb5w6Pxk' : '2FPyTwcZLUg1MDrwsyoP4D6s1tM7hAkHYRjkNb5w6Pxk';
...
export let [globalStateKey, globalStateKeyNonce]: [anchor.web3.PublicKey, number] = [null, null];
