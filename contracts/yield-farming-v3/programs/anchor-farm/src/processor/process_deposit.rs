...
pub fn process_deposit(ctx: Context<Deposit>, _global_state_nonce: u8, _farm_nonce: u8, _farm_pool_lp_nonce: u8, _farm_pool_reward_nonce: u8, _user_info_nonce: u8, _with_swap_action: u8, _amount: u64) -> ProgramResult {
